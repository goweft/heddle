"""Generate Heddle agent configs from natural language descriptions.
...
from heddle.generator.llm import LLMClient, DEFAULT_MODEL
...
SYSTEM_PROMPT = """\
You are Heddle Agent Generator. You produce valid YAML agent configurations
for the Heddle platform. Heddle turns YAML configs into MCP servers automatically.
...
def _build_prompt(description: str, context: str = "") -> str:
    ...
    parts.append(
        f"Generate a Heddle agent YAML config for the following description. "
...
async def generate_agent(
    ...
    """Generate a Heddle agent config from a natural language description.
