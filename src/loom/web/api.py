"""LOOM Web Dashboard — FastAPI backend.

Exposes LOOM's registry, audit log, agent configs, and health data
...
from loom.security.signing import ConfigSigner, AgentQuarantine
...
def create_app() -> FastAPI:
    app = FastAPI(title="LOOM Dashboard", version="1.0.0")
    ...
    async def index():
        ...
        return HTMLResponse("<h1>LOOM Dashboard</h1><p>Frontend not found. Place index.html in src/loom/web/static/</p>")
