"""LOOM multi-agent runner — run and wire multiple agents together.
...
from loom.config.loader import load_agent_config, discover_configs, ConfigError
...
class MultiAgentRunner:
    """Run multiple LOOM agents simultaneously.
