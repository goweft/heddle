"""LOOM Agent Runtime Engine — load config, build MCP server, register, run."""
...
from loom.config.loader import load_agent_config, ConfigError
...
DEFAULT_AGENTS_DIR = Path.home() / ".loom" / "agents"
