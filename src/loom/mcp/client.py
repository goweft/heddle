"""LOOM MCP client — for agents that consume other agents' tools.
...
- Connecting to other LOOM agents or external MCP servers
...
class LoomMCPClient:
    """Client for calling tools on another LOOM agent or MCP server.

    Supports streamable-http transport for remote LOOM agents.
    """
...
class AgentMesh:
    """Manages connections to multiple LOOM agents.
